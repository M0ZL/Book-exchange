...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 12 2025 г., 23:54
...
CREATE TABLE `книги` (
  ...
  `дата_добавления` date DEFAULT NULL,
...
(7, 1, '978-5-17-170204-5', 'Самая страшная книга. Заступа: Чернее черного', 'Иван Белов', 'доступна', '2025-03-10', 'Отечественная фантастика', 2025, 'images/6.jpg');
...
(1, 'test1', 'dedkovanton20@yandex.ru', '123', 'участник', 0, '2025-03-06', 'Дедков', 'Антон', 'Геннадьевич', '446660, обл. Самарская, р-н. Борский, с. Борское, ул. Песочная, д. 1', '+79011111111', 21),
(2, 'test2', 'Nikita@example.com', '789', 'администратор', 0, '2025-03-01', 'Лавренко', 'Никита', NULL, NULL, '+79200000000', 22),
(3, 'test3', 'Grin@example.com', '456', 'участник', 0, '2025-03-05', 'Гринцова', 'Дарья', 'Витальевна', NULL, '+79300000000', 23),
(4, 'test4', 'Kurkina@example.com', '4444', 'участник', 0, '2025-03-05', 'Куркина', 'Юлия', NULL, NULL, '+79400004589', 22),
(5, 'test5', 'Mamykin@example.com', '8888', 'участник', 0, '2025-03-05', 'Мамыкин', 'Глеб', 'Павлович', NULL, '+79500000893', 23),
(6, 'test6', 'Aparin@example.com', '6969', 'участник', 0, '2025-03-05', 'Апарин', 'Александр', NULL, NULL, '+79600000000', 23),
(7, 'test7', 'Zhanatov@example.com', '5151', 'участник', 0, '2025-03-05', 'Жанатов', 'Айсултан', NULL, NULL, '+797000000231', 22),
(8, 'test8', 'boyagin68@gmail.com', '098', 'участник', 0, '2025-03-13', 'Боягин', 'Владислав', 'Алексеевич', '', '+79564873291', 23),
(9, 'test9', 'gareevd@gmail.com', '691', 'участник', 0, '2025-03-13', 'Гареев', 'Дамир', 'Дмитриевич', '', '+79564874098', 23),
(10, 'test10', 'kozlova45@gmail.com', '234', 'участник', 0, '2025-03-13', 'Козлова', 'Валентина', 'Дмитриевна', '', '+79588873291', 23);
...
(3, 1, 5, 'Обмен книги 2 на книгу 5', 'ожидание', '2025-03-12');
...
(2, 2, 2, '5555', 'ожидание', '2025-03-06'),
(3, 3, 2, '27393345145586', 'ожидание', '2025-03-12');
...
--
ALTER TABLE `книги`
  MODIFY `книга_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT для таблицы `пользователи`
--
ALTER TABLE `пользователи`
  MODIFY `пользователь_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT для таблицы `заявки_на_обмен`
--
ALTER TABLE `заявки_на_обмен`
  MODIFY `заявка_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT для таблицы `обмены`
--
ALTER TABLE `обмены`
  MODIFY `обмен_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
