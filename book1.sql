...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 23 2025 г., 06:00
...
(2, 1, '978-5-17-118103-1', 'Война и мир', 'Л.Н. Толстой', 'доступна', '2025-03-06', 'Роман', 1869, 'images/1.jpg'),
...
(1, 'test1', 'dedkovanton20@yandex.ru', '123', 'участник', 'активный', 3, '2025-03-06', 'Дедков', 'Антон', 'Геннадьевич', '446660, обл. Самарская, р-н. Борский, с. Борское, ул. Песочная, д. 1', '+79011111111', 21),
(2, 'test2', 'Nikita@example.com', '789', 'администратор', 'активный', 3, '2025-03-01', 'Лавренко', 'Никита', NULL, NULL, '+79200000000', 22),
...
(6, 'test6', 'Aparin@example.com', '6969', 'участник', 'активный', 0, '2025-03-05', 'Апарин', 'Александр', NULL, NULL, '+79600000000', 23),
...
(2, 2, 'Фантастика', 'не имеет значения', '-', 'Я фигею 24', 'Дедков Антон Геннадьевич', 1, 'ожидание', '2025-03-22 21:55:59'),
...
(6, 5, 'Фантастика', 'не имеет значения', '-', 'Я фигею 24', 'Никита', 2, 'ожидание', '2025-03-23 02:25:06');
...
--
ALTER TABLE `предложения_на_обмен`
  MODIFY `предложение_id` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
