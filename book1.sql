...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 09 2025 г., 16:10
...
(3, 1, '978-5-386-10742-0', 'Уличный кот по имени Боб. Как человек и кот обрели надежду на улицах Лондона', 'Джеймс Боуэн', 'доступна', '2025-03-06', 'Роман', 2018, 'images/2.jpg'),
(4, 1, '978-5-17-163435-3', 'Дикий зверь', 'Жоэль Диккер', 'доступна', '2025-03-04', 'Роман', 2025, '/images/3.webp'),
(5, 1, '978-5-00214-025-1', 'The Book. Как создать цивилизацию заново', 'Коллектив авторов', 'доступна', '2025-03-05', NULL, 2023, '/images/4.webp'),
(6, 1, '978-5-00195-984-7', 'Египетская «Книга мертвых»', 'Коллектив авторов', 'доступна', '2025-03-02', 'Мифы и легенды', 2024, '/images/5.webp');
...
--
ALTER TABLE `отзывы`
  MODIFY `отзыв_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
