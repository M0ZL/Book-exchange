...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 03 2025 г., 09:40
...
(1, 'test1', 'dedkovanton20@yandex.ru', '123', 'участник', 'активный', 6, '2025-03-06', 'Дедков', 'Антон', 'Геннадьевич', '446660, обл. Самарская, р-н. Борский, с. Борское, ул. Песочная, д. 1', '+79011111111', 21),
(2, 'test2', 'Nikita@example.com', '789', 'администратор', 'активный', 6, '2025-03-01', 'Лавренко', 'Никита', NULL, NULL, '+79200000000', 22),
...
(7, 3, 8, 1, 2, 1, '000000000000000', '00000000000000000', 1, 1, 1);
...
(3, 2, 'Фантастика', 'не имеет значения', '-', 'Я фигею 24', 'Дедков Антон Геннадьевич', 1, 'подтвержден', '2025-03-22 21:58:01'),
...
(4, 1, 5, 5, 'Отличный сайт!', '2025-03-29 00:00:00'),
(5, 2, 5, 5, 'Все нравится', '2025-03-29 00:00:00'),
(6, 2, 5, 4, 'Хороший сайт', '2025-03-29 00:00:00'),
(7, 2, 5, 4, 'Рекомендую!', '2025-03-29 00:00:00'),
(8, 2, NULL, 4, 'Хороший сайт для обмена книгами', '2025-03-29 00:00:00'),
(9, 2, 5, 3, 'Нормально', '2025-03-29 00:00:00'),
(10, 2, 5, 3, 'Нормально', '2025-03-29 00:00:00'),
(11, 2, 7, 4, 'Круто', '2025-04-03 00:00:00'),
(12, 1, 7, 4, 'Отлично', '2025-04-03 11:36:20');
...
--
ALTER TABLE `предложения_на_обмен`
  MODIFY `предложение_id` int(13) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `отзывы`
  MODIFY `отзыв_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
