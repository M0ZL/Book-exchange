...
--
-- Хост: localhost
-- Время создания: Мар 02 2025 г., 20:48
...
CREATE TABLE `пользователи` (
  ...
  `Статус` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT 'Активный'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `заявки_на_обмен` (
  `ID` int NOT NULL,
  `Пользователь_ID` int NOT NULL,
  `Книга_для_обмена_ID` int NOT NULL,
  `Книга_в_обмен_ID` int NOT NULL,
  `Дата_заявки` datetime DEFAULT CURRENT_TIMESTAMP,
  `Статус` enum('Ожидает','Принята','Отклонена') COLLATE utf8mb4_general_ci DEFAULT 'Ожидает'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
